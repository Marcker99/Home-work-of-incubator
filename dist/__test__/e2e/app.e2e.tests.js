...
describe('/videos', () => {
    ...
    beforeAll(() => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, supertest_1.default)(setting_1.app).delete('/testing/all-data').expect(204);
    }));
    it('GET products = []', () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, supertest_1.default)(setting_1.app).get('/videos/').expect([]);
    }));
    it('- POST does not create the video with incorrect data (no title, no author)', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield (0, supertest_1.default)(setting_1.app).get('/videos/');
            expect(res.body).toEqual([]);
        });
    });
    it('- GET product by ID with incorrect id', () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, supertest_1.default)(setting_1.app).get('/videos/helloWorld').expect(400);
    }));
